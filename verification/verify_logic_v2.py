...
def run_verification():
    with sync_playwright() as p:
        ...
        # Wait for window.state to be defined
        page.wait_for_function("typeof window.state !== 'undefined' && window.state !== null")
        ...
        results = page.evaluate("""
            () => {
                ...
                if (typeof populateDynamicSelectors === 'function') {
                    ...
                    return { error: 'populateDynamicSelectors not found' };
                }
